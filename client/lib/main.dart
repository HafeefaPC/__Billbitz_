          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                _buildRotatedImage(
                  'assets/images/hero1.jpg', // Path to the first image
                  100, // Height
                  100, // Width
                  BoxFit.contain, // BoxFit
                  -0.4, // Angle
                ),
                // Rotate hero1 anticlockwise by 0.4 radians
                SizedBox(width: 50), // Adjust spacing between images
                _buildRotatedImage('assets/images/hero3.jpg', 100, 100,
                    BoxFit.cover, -0.2), // No rotation for hero3
              ],
            ),
            ...
            Row(
              ...
              children: [
                ...
                _buildRotatedImage(
                    ...
                    100,
                    BoxFit.cover,
                    -0.2), // No rotation for hero3 (second occurrence)
                SizedBox(width: 30), // Adjust spacing between images
